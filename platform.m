...
function  params = prompt_parameters()
    ...
    defaults = ('n_rows':n_rows, 'x_distance':x_distance, "n_cols":n_cols, ...
...
function [initial_accel_x, initial_accel_y] = setAccel(x_accel, y_accel)
    %%
...
%%
function output_file = run_scan(n_rows, x_distance, n_cols, y_distance, units,...
             time1, time_at_point, x_accel, y_accel, units_accel))
    %% validate arguements?
